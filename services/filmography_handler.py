...
Return ONLY valid JSON."""
    ...
    try:
        ...
        logger.warning("Rate limited during filmography query analysis, using raw query as person name")
        return {
...
Write naturally. Vary your style. Connect the dots."""
    ...
    try:
        ...
        logger.warning("Rate limited in generate_filmography_response")
        return {
            "success": False,
            "error": "rate_limited",
            "message": t("rate_limited", language),
            "person": person,
            "films": films_final
        }
